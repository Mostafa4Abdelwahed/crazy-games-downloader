...
export const DiagnosticCode = {
  ...
  UNITY_STREAMING_ASSETS_DISCOVERY_STARTED:
    'UNITY_STREAMING_ASSETS_DISCOVERY_STARTED',
  UNITY_STREAMING_ASSET_DISCOVERED: 'UNITY_STREAMING_ASSET_DISCOVERED',
  UNITY_STREAMING_ASSETS_DISCOVERY_COMPLETED:
    'UNITY_STREAMING_ASSETS_DISCOVERY_COMPLETED',
  UNITY_STREAMING_ASSETS_DISCOVERY_LIMIT_REACHED:
    'UNITY_STREAMING_ASSETS_DISCOVERY_LIMIT_REACHED',
  UNITY_STREAMING_ASSET_DOWNLOAD_STARTED:
    'UNITY_STREAMING_ASSET_DOWNLOAD_STARTED',
  UNITY_STREAMING_ASSET_DOWNLOAD_COMPLETED:
    'UNITY_STREAMING_ASSET_DOWNLOAD_COMPLETED',
  UNITY_STREAMING_ASSET_DOWNLOAD_FAILED:
    'UNITY_STREAMING_ASSET_DOWNLOAD_FAILED',
  UNITY_RUNTIME_ASSET_MISSING: 'UNITY_RUNTIME_ASSET_MISSING',
  UNITY_RUNTIME_ASSET_REQUEST_FAILED: 'UNITY_RUNTIME_ASSET_REQUEST_FAILED',
  UNITY_ADDRESSABLES_DISCOVERY_STARTED: 'UNITY_ADDRESSABLES_DISCOVERY_STARTED',
  UNITY_ADDRESSABLES_SETTINGS_FOUND: 'UNITY_ADDRESSABLES_SETTINGS_FOUND',
  UNITY_ADDRESSABLES_CATALOG_FOUND: 'UNITY_ADDRESSABLES_CATALOG_FOUND',
  UNITY_ADDRESSABLES_CATALOG_MISSING: 'UNITY_ADDRESSABLES_CATALOG_MISSING',
  UNITY_ADDRESSABLES_DISCOVERY_COMPLETED:
    'UNITY_ADDRESSABLES_DISCOVERY_COMPLETED',
  ...
  HTML5_ENTRY_FOUND: 'HTML5_ENTRY_FOUND',
  HTML5_ASSET_DISCOVERED: 'HTML5_ASSET_DISCOVERED',
  HTML5_ASSET_LIMIT_REACHED: 'HTML5_ASSET_LIMIT_REACHED',
  HTML5_SDK_STUB_INJECTED: 'HTML5_SDK_STUB_INJECTED',
  HTML5_RUNTIME_ASSET_DISCOVERED: 'HTML5_RUNTIME_ASSET_DISCOVERED',
  HTML5_MANIFEST_FOUND: 'HTML5_MANIFEST_FOUND',
